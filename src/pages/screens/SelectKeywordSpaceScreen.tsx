...
type SpaceKeywordSelectionScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'SelectSpaceKeyword'
>;

type SpaceKeywordSelectionScreenRouteProp = RouteProp<
  RootStackParamList,
  'SelectSpaceKeyword'
>;

const SelectKeywordSpaceScreen: React.FC = () => {
  const futureKeywords = ['탐사', '외계인', '블랙홀', '우주선', '우주 전쟁'];

  const navigation = useNavigation<SpaceKeywordSelectionScreenNavigationProp>();
  const route = useRoute<SpaceKeywordSelectionScreenRouteProp>();
...
export default SelectKeywordSpaceScreen;
