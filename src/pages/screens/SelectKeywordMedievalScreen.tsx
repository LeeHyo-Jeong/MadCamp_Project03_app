...
type MedievalKeywordSelectionScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'SelectMedievalKeyword'
>;

type MedievalKeywordSelectionScreenRouteProp = RouteProp<
  RootStackParamList,
  'SelectMedievalKeyword'
>;

const SelectKeywordMedievalScreen: React.FC = () => {
  const futureKeywords = ['전쟁', '모험', '영지 관리', '종교 전쟁', '마법'];

  const navigation =
    useNavigation<MedievalKeywordSelectionScreenNavigationProp>();
  const route = useRoute<MedievalKeywordSelectionScreenRouteProp>();
...
export default SelectKeywordMedievalScreen;
