...
type SelectInitialStatsScreenMedievalNavigationProp = StackNavigationProp<
  RootStackParamList,
  'SelectInitialStatsMedieval'
>;

type SelectInitialStatsMedievalScreenRouteProp = RouteProp<
  RootStackParamList,
  'SelectInitialStatsMedieval'
>;
...
const SelectInitialStatsMedievalScreen: React.FC = () => {
  const navigation =
    useNavigation<SelectInitialStatsScreenMedievalNavigationProp>();
  const route = useRoute<SelectInitialStatsMedievalScreenRouteProp>();
...
export default SelectInitialStatsMedievalScreen;
