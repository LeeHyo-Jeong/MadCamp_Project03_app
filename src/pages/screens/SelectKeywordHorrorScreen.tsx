...
type HorrorKeywordSelectionScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'SelectHorrorKeyword'
>;

type HorrorKeywordSelectionScreenRouteProp = RouteProp<
  RootStackParamList,
  'SelectHorrorKeyword'
>;

const SelectKeywordHorrorScreen: React.FC = () => {
  const futureKeywords = ['유령', '악몽', '심령', '초자연 현상', '폐가'];

  const navigation =
    useNavigation<HorrorKeywordSelectionScreenNavigationProp>();
  const route = useRoute<HorrorKeywordSelectionScreenRouteProp>();
...
export default SelectKeywordHorrorScreen;
